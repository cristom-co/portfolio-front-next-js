  ...
  return (
    <footer className="py-8">
      ...
      <div className="relative flex items-center justify-center">
        <div className="w-11/12 md:w-8/12 border-2 px-12 py-5">
          <Image className='mt-5'
            ...
            <p>+57 3015567050 - cristhiantombe@gmail.com</p>
            ...
            <div className="flex space-x-4 mt-10">
                ...
                <a href="https://www.youtube.com/@cristhiantombe3181" target="__blank" className="text-gray-600 hover:text-gray-800">
