...
const Footer = () => {
  ...
  return (
    <footer className="py-8 px-4 sm:px-6 lg:px-8 container mx-auto">

      <div className="relative flex items-center justify-center">
        <div className="container mx-auto border-2 px-4 py-5 grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <div className="flex justify-center items-center">
            <Image
              ...
              width={150}
              height={150}
              alt="Cristhian Tombe - Desarrollador Web Full Stack"
            />
          </div>
            <div className="flex space-x-4 mt-10 justify-end items-end">
            <a href="https://www.linkedin.com/in/cristombe/" target="_blank" className="text-gray-600 hover:text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            {/* TODO: Update these placeholder links with actual routes */}
            ...
            <a href="/cookie-settings" className="text-gray-300 hover:text-white">
            {t("cookieSettings")}
            </a>
          </div>
        </div>
