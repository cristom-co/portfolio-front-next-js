...
export const experience = [
    ...
    },
    {
        ...
        description: "I began working with the first version of Angular, where I helped develop an internal application to digitize a company's credit application process. Previously reliant on paper forms, the system allowed all employees to access and manage credit requests efficiently. Later, I transitioned to React to enhance the system’s scalability and usability, ensuring a seamless experience across devices and improving the overall workflow for the company."
    },
    {
        type: 'text',
        image: '',
...
export const contacts = [
    ...
    {
        type: 'link',
        image: '/images/contact/upwork.png',
        imageComplete: '',
        title: '',
        description: '',
